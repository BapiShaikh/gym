                ...
                <div class="card-body">
                    <table class="display dataTable cell-border datatbl-advance">
                        ...
                        <?php $__currentLoopData = $trainees; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $trainee): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <tr>
                                <?php echo e(!empty($trainee->traineeDetail) ? traineePrefix() . $trainee->traineeDetail->trainee_id : '-'); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\xink_soft\gym-management-system\main_file\resources\views/trainee/index.blade.php ENDPATH**/ ?>