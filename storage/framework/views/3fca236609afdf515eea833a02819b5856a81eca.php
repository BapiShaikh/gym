                ...
                <div class="intro-contain">
                    <div>
                        <h2 class="wow fadeInLeft"
                            data-wow-duration="1s"><?php echo e(__('FitHub - Gym Management Tool')); ?></h2>
                        <p class="wow fadeInLeft"
                           data-wow-duration="1.5s"><?php echo e(__('A FitHub system is a software solution designed to streamline and automate the administrative and operational tasks involved in running a fitness center or gym.')); ?></p>
        ...
        <div class="row">
            <div class="col-lg-8 offset-lg-2 col-md-10 offset-md-1">
                <div class="land-title">
                    ...
                    <p class="wow fadeInRight"><?php echo e(__('A FitHub system is a software solution designed to streamline and automate the administrative and operational tasks involved in running a fitness center or gym.')); ?></p>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-lg-6">
                <div class="header-detail">
                    <div>
                        <h2 class="wow fadeInUp" data-wow-duration="0.8s">500+ <?php echo e(__('Trainer')); ?></h2>
                        <p class="wow fadeInUp"
                           data-wow-duration="1.3s"><?php echo e(__('A FitHub system is a software solution designed to streamline and automate the administrative and operational tasks involved in running a fitness center or gym.')); ?></p>
                        <a
                    ...
                    <div class="col-lg-12 col-md-6">
                        <div class="demo-grid">
                            <div class="img-wrap"><img class="img-fluid"
                                                       ...
                                                       alt=""></div>
                            <div class="demo-detail">
                                <h3 class="text-white"><?php echo e(__('Classes')); ?></h3>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-12 col-md-6">
                        <div class="demo-grid">
                            <div class="img-wrap"><img class="img-fluid"
                                                       ...
                                                       alt=""></div>
                            <div class="demo-detail">
                                <h3 class="text-white"><?php echo e(__('Invoice Details')); ?></h3>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-12 col-md-6">
                        <div class="demo-grid">
                            <div class="img-wrap"><img class="img-fluid"
                                                       ...
                                                       alt=""></div>
                            <div class="demo-detail">
                                <h3 class="text-white"><?php echo e(__('Expense')); ?></h3>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-12 col-md-6">
                        <div class="demo-grid">
                            <div class="img-wrap"><img class="img-fluid"
                                                       ...
                                                       alt=""></div>
                            <div class="demo-detail">
                                <h3 class="text-white"><?php echo e(__('Attendance')); ?></h3>
                            </div>
                        </div>
                    </div>
                </div>
...
<?php /**PATH C:\xampp\htdocs\xink_soft\gym-management-system\main_file\resources\views/layouts/landing.blade.php ENDPATH**/ ?>