...
<?php $__env->startSection('card-action-btn'); ?>
    <?php if(Gate::check('manage trainer')): ?>
        <a class="btn btn-primary btn-sm ml-20 customModal" href="#" data-size="lg"
           data-url="<?php echo e(route('trainers.create')); ?>"
           data-title="<?php echo e(__('Create Trainer')); ?>"> <i
                    ...
                    <table class="display dataTable cell-border datatbl-advance">
                        ...
                        <?php $__currentLoopData = $trainers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $trainer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <tr>
                                ...
                                <td class="table-user">
                                    <img
                                        src="<?php echo e(!empty($trainer->avatar)?asset(Storage::url('upload/profile')).'/'.$trainer->avatar:asset(Storage::url('upload/profile')).'/avatar.png'); ?>"
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\xink_soft\gym-management-system\main_file\resources\views/trainer/index.blade.php ENDPATH**/ ?>